...
<div class="w3-container">
    <div>
        ...
        <h2 style="text-align: center">Sakila - <spring:message code="application.country"/></h2>
    </div>
    <br>
    <a class="w3-button" href="<c:url value="/" />"><spring:message code="application.back"/></a>

    <div class="w3-container w3-center">
        <a class="w3-button mb-4" href="<c:url value="countryModify" />"><spring:message code="application.new"/></a>
